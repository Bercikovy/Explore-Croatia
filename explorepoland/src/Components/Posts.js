    ...
    <section className="postsWrapper parallax" id="Posts">
      ...
      <div className="postsContent">
        ...
        <p>
          ...
          zadanie. Chorwacja i Dalmacja oferuje tyle wspaniałych zakątków, że
          nie sposób zmieścić je w takiej skondensowanej formie. Nie traktujcie
          więc tego zestawienia zbyt poważnie. Na pewno wiele miejsc w nim
          brakuje. Nie gniewajcie się. To tylko subiektywna propozycja punktów
          do odwiedzenia. Więcej, o wiele więcej odkryjecie już na własną rękę,
          do czego gorąco zachęcamy, bo Chorwacja jest piękna!
        </p>
      </div>
